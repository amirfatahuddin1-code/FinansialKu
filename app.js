        ...
        if (data && data.token) {
            ...
            if (processingEl) {
                processingEl.innerHTML = `
                    ...
                    <p style="font-weight: 600;">Mengalihkan ke Mayar...</p>
                    <p style="font-size: 0.8rem; color: var(--text-muted);">Mohon tunggu sebentar, Anda akan segera diarahkan ke halaman pembayaran aman.</p>
                `;
            }
